"""Lab 08 McDonald's peer P/E comparison; uses only Python's standard library."""

# September 10, 2026 closing prices and FY2025 reported GAAP diluted EPS.
target = {"ticker": "MCD", "price": 253.48, "diluted_eps": 11.95}
peers = [
    {"ticker": "YUM", "price": 143.89, "diluted_eps": 5.55},
    {"ticker": "QSR", "price": 76.49, "diluted_eps": 2.35},
]
